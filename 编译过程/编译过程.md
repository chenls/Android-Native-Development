...
[jni](../source/helloWorld/jni/)工程在中，同样的"Hello World"示例代码，增加了ndk编译脚本[Application.mk](../source/helloWorld/jni/Application.mk)、[Android.mk](../source/helloWorld/jni/Android.mk)，进入jni目录中使用`ndk-build`编译：
